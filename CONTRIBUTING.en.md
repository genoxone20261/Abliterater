...
Patches, measurements, and reviews are welcome — **please contribute with us.** Completeness is not high yet. Do not upload keys or research dumps. Third-party commercial use, illegal use, and abuse are **not licensed** — [ACCEPTABLE-USE.en.md](./ACCEPTABLE-USE.en.md). Use **outside our grant** is unauthorized. **Illegal acts you commit with this software or with models or outputs you produce using it are your responsibility.** A PR is a grant on AGPL-3.0-or-later **and** those additional terms.
...
- Tabs are **Workbench (1)** / **Research (2)** only. No document-library tab.
