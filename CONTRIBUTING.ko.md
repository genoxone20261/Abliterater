...
한 줄: 패치·실측·리뷰를 **같이 기여**해 주시면 고맙겠습니다. 완성도는 아직 높지 않습니다. 키·연구 덤프는 올리지 마십시오. 제3자 상업 이용과 불법·악용은 **라이선스되지 않습니다** — [ACCEPTABLE-USE.ko.md](./ACCEPTABLE-USE.ko.md). **우리 허락을 넘는 사용은 허가되지 않습니다. 불법 이용의 책임은 그 사용자에게 있습니다.** PR은 AGPL-3.0-or-later와 그 추가 조건에 대한 부여입니다.
...
- 탭은 **작업대(1)** / **연구 자료(2)** 만. 문서 라이브러리 탭을 만들지 않는다.
