...
Не хостит веса, не арендует GPU за вас, не vendor AGPL в `src/`, не кладёт авторские KDP PDF в продукт, не закрывает native/GPU журналы из-за `npm test`. analog `:8080` ≠ native close.
