...
## Why TODO files are in the public tree
...
| File | Why |
| --- | --- |
| `docs/maximum-completion/TODO-ROADMAP.md` | `npm run ledger:status` and tests read native 01–20 OPEN |
...
Per-ledger OPEN (do not sum): native 02, 13, 14, 16, 18, 20 · R-004, R-005 · R-009 · W01, W02, W06–W09, W11, W12, W14, W16 · C-002–C-007.
...
GENOX · Juno Andy Cheong · AGPL-3.0-or-later
